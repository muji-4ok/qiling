...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-r", "--reg", help="Dump register values with trace option", action="store_true", default=False
    )
    ...
    parser.add_argument("-p ", "--profile", help="customized profile", default="qiling/profiles/windows.ql")
