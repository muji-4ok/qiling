...
class ELFTest(unittest.TestCase):
    ...
    def test_elf_linux_x8664(self):
        ...
        ql = Qiling(
            ["../examples/rootfs/x8664_linux/bin/x8664_args", "1234test", "12345678", "bin/x8664_hello"],
            "../examples/rootfs/x8664_linux",
            verbose=QL_VERBOSE.DEBUG,
        )
    ...
    def test_elf_linux_mips32(self):
        ...
        ql = Qiling(
            ["../examples/rootfs/mips32_linux/bin/mips32_hello", random_generator(random.randint(1, 99))],
    ...
    def test_elf_onEnter_mips32el(self):
        ...
        ql = Qiling(
            ["../examples/rootfs/mips32el_linux/bin/mips32el_double_hello"], "../examples/rootfs/mips32el_linux"
        )
    ...
    def test_elf_linux_mips32el(self):
        ...
        ql = Qiling(
            ["../examples/rootfs/mips32el_linux/bin/mips32el_hello", random_generator(random.randint(1, 99))],
    ...
    def test_elf_linux_mips32el_static(self):
        ...
        ql = Qiling(
            ["../examples/rootfs/mips32el_linux/bin/mips32el_hello_static", random_generator(random.randint(1, 99))],
            "../examples/rootfs/mips32el_linux",
        )
        ql.run()
        del ql
    ...
    def test_arm_directory_symlink(self):
        ql = Qiling(
            ["../examples/rootfs/arm_linux/bin/arm_hello"], "../examples/rootfs/arm_linux", verbose=QL_VERBOSE.DEBUG
        )
        real_path = ql.os.path.transform_to_real_path("/lib/libsymlink_test.so")
        self.assertTrue(
            real_path.endswith("/examples/rootfs/arm_linux/tmp/media/nand/symlink_test/libsymlink_test.so")
        )
        del ql
