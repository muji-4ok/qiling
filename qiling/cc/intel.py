...
class QlIntelBaseCC(QlCommonBaseCC):
    ...
    def __init__(self, ql: Qiling):
        retreg = {16: UC_X86_REG_AX, 32: UC_X86_REG_EAX, 64: UC_X86_REG_RAX}[ql.archbit]
...
class macosx64(QlIntel64):
    ...
    _argregs = (UC_X86_REG_RDI, UC_X86_REG_RSI, UC_X86_REG_RDX, UC_X86_REG_RCX, UC_X86_REG_R8, UC_X86_REG_R9) + (
        None,
    ) * 10
