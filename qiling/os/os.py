...
class QlOs:
    ...
    def __init__(self, ql: Qiling, resolvers: Mapping[Any, Resolver] = {}):
        ...
        self.user_defined_api = {QL_INTERCEPT.CALL: {}, QL_INTERCEPT.ENTER: {}, QL_INTERCEPT.EXIT: {}}
        ...
        # defult exit point
        self.exit_point = {16: 0xFFFFF, 32: 0x8FFFFFFF, 64: 0xFFFFFFFFFFFFFFFF}.get(  # 20bit address lane
            self.ql.archbit, None
        )
