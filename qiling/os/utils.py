...
class QlOsUtils:
    ...
    def print_function(
        self, address: int, fname: str, pargs: Sequence[Tuple[str, str]], ret: Union[int, str, None], passthru: bool
    ):
    ...
    def va_list(self, format: str, ptr: int) -> MutableSequence[int]:
        ...
        return [
            self.ql.unpack(self.ql.mem.read(ptr + i * self.ql.pointersize, self.ql.pointersize)) for i in range(count)
        ]
