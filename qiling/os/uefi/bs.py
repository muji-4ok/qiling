...
@dxeapi(
    params={"Event": POINTER, "Type": ULONGLONG, "TriggerTime": ULONGLONG}  # EFI_EVENT  # EFI_TIMER_DELAY  # UINT64
)
...
@dxeapi(params={"ImageHandle": POINTER, "MapKey": ULONGLONG})  # EFI_HANDLE  # UINTN
...
@dxeapi(params={"Data": POINTER, "DataSize": ULONGLONG, "Crc32": POINTER})  # PTR(VOID)  # UINTN  # PTR(UINT32)
...
@dxeapi(params={"Destination": POINTER, "Source": POINTER, "Length": SIZE_T})  # PTR(VOID)  # PTR(VOID)  # UINTN
...
@dxeapi(params={"Buffer": POINTER, "Size": SIZE_T, "Value": BYTE})  # PTR(VOID)  # UINTN  # UINT8
