...
class EFI_SMM_CPU_PROTOCOL(STRUCT):
    ...
    _fields_ = [
        ...
        (
            "SmmWriteSaveState",
            FUNCPTR(PTR(EFI_SMM_CPU_PROTOCOL), UINTN, EFI_SMM_SAVE_STATE_REGISTER, UINTN, PTR(VOID)),
        ),
    ]
...
descriptor = {
    ...
    "fields": (("SmmReadSaveState", hook_SmmReadSaveState), ("SmmWriteSaveState", hook_SmmWriteSaveState)),
}
