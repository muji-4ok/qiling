...
@dxeapi(params={"Time": POINTER, "Capabilities": POINTER})  # OUT PTR(EFI_TIME)  # OUT PTR(EFI_TIME_CAPABILITIES)
...
@dxeapi(params={"DebugDisposition": UINT, "Address": POINTER})  # UINTN  # OUT PTR(PTR(VOID))
