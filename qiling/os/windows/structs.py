...
class LDR_DATA_TABLE_ENTRY:
    def __init__(
        ...
        self.FullDllName["BufferPtr"] = ql.heap.alloc(self.FullDllName["MaximumLength"])
        ...
        self.BaseDllName["BufferPtr"] = ql.heap.alloc(self.BaseDllName["MaximumLength"])
...
class UNICODE_STRING64(ctypes.Structure):
    _pack_ = 8
    _fields_ = (("Length", ctypes.c_uint16), ("MaximumLength", ctypes.c_int16), ("Buffer", ctypes.c_uint64))


class UNICODE_STRING32(ctypes.Structure):
    _pack_ = 4
    _fields_ = (("Length", ctypes.c_uint16), ("MaximumLength", ctypes.c_int16), ("Buffer", ctypes.c_uint32))
...
class KSYSTEM_TIME(ctypes.Structure):
    _fields_ = (("LowPart", ctypes.c_uint32), ("High1Time", ctypes.c_int32), ("High2Time", ctypes.c_int32))
...
class KDEVICE_QUEUE_ENTRY32(ctypes.Structure):
    _pack_ = 4
    _fields_ = (("DeviceListEntry", LIST_ENTRY32), ("SortKey", ctypes.c_uint32), ("Inserted", ctypes.c_uint8))


class WAIT_ENTRY32(ctypes.Structure):
    _pack_ = 4
    _fields_ = (("DmaWaitEntry", LIST_ENTRY32), ("NumberOfChannels", ctypes.c_uint32), ("DmaContext", ctypes.c_uint32))
...
class KDEVICE_QUEUE_ENTRY64(ctypes.Structure):
    _pack_ = 8
    _fields_ = (("DeviceListEntry", LIST_ENTRY64), ("SortKey", ctypes.c_uint32), ("Inserted", ctypes.c_uint8))


class WAIT_ENTRY64(ctypes.Structure):
    _pack_ = 8
    _fields_ = (("DmaWaitEntry", LIST_ENTRY64), ("NumberOfChannels", ctypes.c_uint32), ("DmaContext", ctypes.c_uint32))
...
class GROUP_AFFINITY32(ctypes.Structure):
    _fields_ = (("Mask", ctypes.c_uint32), ("Group", ctypes.c_uint16), ("Reserved", ctypes.c_uint16 * 3))
...
class CLIENT_ID32(ctypes.Structure):
    _fields_ = (("UniqueProcess", ctypes.c_uint32), ("UniqueThread", ctypes.c_uint32))


class CLIENT_ID64(ctypes.Structure):
    _fields_ = (("UniqueProcess", ctypes.c_uint64), ("UniqueThread", ctypes.c_uint64))
...
class SystemTime(WindowsStruct):
    ...
    def write(self, addr):
        super().generic_write(
            addr,
            [self.year, self.month, self.day_week, self.day, self.hour, self.minute, self.seconds, self.milliseconds],
        )
...
class ProcessBasicInformation(WindowsStruct):
    ...
    def write(self, addr):
        super().generic_write(
            addr,
            [self.exitStatus, self.pebBaseAddress, self.affinityMask, self.basePriority, self.pid, self.parentPid],
        )
