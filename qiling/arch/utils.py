...
__cs_endian = {QL_ENDIAN.EL: CS_MODE_LITTLE_ENDIAN, QL_ENDIAN.EB: CS_MODE_BIG_ENDIAN}

__ks_endian = {QL_ENDIAN.EL: KS_MODE_LITTLE_ENDIAN, QL_ENDIAN.EB: KS_MODE_BIG_ENDIAN}

__reg_cpsr_v = {QL_ENDIAN.EL: 0b100000, QL_ENDIAN.EB: 0b100000}  # FIXME: should be: 0b000000
