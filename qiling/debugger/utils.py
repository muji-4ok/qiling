...
class QlReadELF(object):
    ...
    def elf_file_header(self):
        ...
        add_info("Magic", " ".join("%2.2x" % byte2int(b) for b in self.elffile.e_ident_raw))
        ...
        add_info("Flags", [self._format_hex(header["e_flags"]), self.decode_flags(header["e_flags"])])
    ...
    def elf_symbol_tables(self):
        ...
        for section in symbol_tables:
            ...
            for nsym, symbol in enumerate(section.iter_symbols()):
                ...
                symbol_info["Value"] = self._format_hex(symbol["st_value"], fullhex=True, lead0x=False)
